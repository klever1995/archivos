...
const ModalAccesos = ({ idEmpresa, onClose }) => {
  ...
  const handleEliminarAcceso = async (idAcceso) => {
    setLoadingStates(prev => ({ ...prev, eliminar: { ...prev.eliminar, [idAcceso]: true } }));
    ...
    if (!window.confirm(
      ...
      setLoadingStates(prev => ({ ...prev, eliminar: { ...prev.eliminar, [idAcceso]: false } }));
      return;
    }
                    ...
                    <td>
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button 
                          ...
                          disabled={loadingStates.eliminar[acceso.idAcceso]}
                        >
                          Editar
                        </button>
                        <button 
                          ...
                          disabled={loadingStates.eliminar[acceso.idAcceso]}
                        >
                          {loadingStates.eliminar[acceso.idAcceso] ? '⏳' : 'Eliminar'}
                        </button>
                      </div>
                    </td>
                  </tr>
