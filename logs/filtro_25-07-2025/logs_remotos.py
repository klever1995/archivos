...
def insertar_logs_remotos(reporte, idServidor, idAuditoria):
    """
    Versión final corregida que:
    1. Verifica IDs antes de insertar
    2. Maneja correctamente el contexto de aplicación
    3. Incluye validación completa de datos
    """
    ...
    try:
        ...
        with app.app_context():
            ...
            db.session.commit()
            logger.info(f"Insertados {len(registros)} registros correctamente")
