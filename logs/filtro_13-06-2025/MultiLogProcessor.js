...
const MultiLogProcessor = () => {
  ...
  // Agregar nuevo servidor (persistente)
  ...
  try {
    ...
    // Actualizar la lista de servidores eliminando el servidor borrado
