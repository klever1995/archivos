...
const TableroLogs = () => {
  ...
  console.log("📩 Mensaje recibido del backend:", event.data); // siempre verás esto en DevTools
  ...
  try {
    ...
    // --- Mensaje de proceso finalizado desde backend ---
    if (message.tipo === 'test_backend' || message.tipo === 'proceso_finalizado') {
      console.log("✅ Mensaje de proceso finalizado recibido:", message);
      // Aquí podrías agregar otras acciones, como mostrar un toast, actualizar UI, etc.
    }
