...
class loLogs(db.Model):
    ...
    idAuditoria = db.Column(db.Integer, db.ForeignKey('LO_PROCESOS.idAuditoria'), nullable=True)  # Cambiado de idProceso a idAuditoria
    ...
    proceso = db.relationship('LoProcesos', foreign_keys=[idAuditoria], backref='logs')  # Actualizado para usar idAuditoria
