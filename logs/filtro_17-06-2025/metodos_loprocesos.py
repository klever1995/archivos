...
class ProcesosLogger:
    ...
    def reservar_bloque(
        ...
        """
        Reserva un bloque de bytes para procesamiento con tamaño de bloque fijo.
        - Si forzar_completo=True, procesa todo el archivo (para archivos pequeños)
        - Si bloque_size es None, usa 10MB como tamaño fijo (máximo)
        - Si el archivo es <= 1MB, se procesa completo
