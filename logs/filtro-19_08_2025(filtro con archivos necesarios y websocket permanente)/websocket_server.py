...
# Gestión de conexiones WebSocket activas por empresa
...
# Establece nueva conexión y la registra
...
# Elimina conexión de los registros
...
# Envía mensajes con reintentos (uso interno)
...
# Envía mensaje de texto a todos los clientes de una empresa
...
# Envía mensaje JSON a todos los clientes de una empresa  
