...
- El nivel de criticidad (leve, normal, crítico) basado en el impacto en el sistema

IMPORTANTE: Para que el backend pueda parsear de forma fiable, responde EXACTAMENTE en el siguiente formato para CADA error (sin texto adicional ni encabezados generales):
...
Los logs están separados por '🔹🔹🔹'. Responde SOLO con el análisis de cada error, manteniendo el mismo orden de los logs proporcionados.
"""
